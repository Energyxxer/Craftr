...

    {
        ...
        ThemeChangeListener.addThemeChangeListener(t -> {
            if(this.namespace != null) {
                ...
                setBorderColor      (t.getColor(this.namespace + ".dropdown.border",              t.getColor("General.dropdown.border",             new Color(200, 200, 200))));
                ...
                setBorderColor      (t.getColor("General.dropdown.border",             new Color(200, 200, 200)));
