    ...
    public StyledFileField(byte operation, File file, String namespace) {
        ...
        ThemeChangeListener.addThemeChangeListener(t -> {
            ...
            if(this.namespace != null) {
                ...
                field.setBorder(t.getColor(this.namespace + ".textfield.border.color",               t.getColor("General.textfield.border.color",              new Color(200, 200, 200))),Math.max(t.getInteger(this.namespace + ".textfield.border.borderThickness", t.getInteger("General.textfield.border.borderThickness", 1)),0));
                ...
                button.setBorder(t.getColor(this.namespace + ".button.border.color",              t.getColor("General.button.border.color",             new Color(200, 200, 200))), Math.max(t.getInteger(this.namespace + ".button.border.thickness", t.getInteger("General.button.border.thickness",1)),0));
                ...
                field.setBorder(t.getColor("General.textfield.border.color",              new Color(200, 200, 200)),Math.max(t.getInteger("General.textfield.border.borderThickness", 1),0));
                ...
                button.setBorder(t.getColor("General.button.border.color",             new Color(200, 200, 200)), Math.max(t.getInteger("General.button.border.thickness",1),0));
