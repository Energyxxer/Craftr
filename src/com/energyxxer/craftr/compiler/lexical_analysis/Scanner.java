package com.energyxxer.craftr.compiler.lexical_analysis;
...
public class Scanner {
	...
	public Scanner(File file, String str, TokenStream stream) {
		this.stream = stream;
	...
	private void tokenize(File file, String str, ScannerProfile profile) {
		this.file = file;
