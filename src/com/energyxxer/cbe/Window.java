	...
	public Window() {
		...
		if (true) {
			{
				...
				JMenuItem saveItem = new JMenuItem("Save", new ImageIcon(ImageManager.load("/assets/icons/save.png")
				...
				JMenuItem saveAsItem = new JMenuItem("Save As", new ImageIcon(ImageManager
						.load("/assets/icons/save_as.png").getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));
				menu.add(saveAsItem);
				...
				JMenuItem saveAllItem = new JMenuItem("Save All", new ImageIcon(ImageManager
						.load("/assets/icons/save_all.png").getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));
				...
				JMenuItem renameItem = new JMenuItem("Rename", new ImageIcon(ImageManager
						.load("/assets/icons/rename.png").getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));
				menu.add(renameItem);

				// --------------------------------------------------

				JMenuItem refreshItem = new JMenuItem("Refresh", new ImageIcon(ImageManager
						.load("/assets/icons/reload.png").getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));
...

			{
				...
				JMenuItem undoItem = new JMenuItem("Undo                    ", new ImageIcon(ImageManager
						.load("/assets/icons/undo.png").getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));
				menu.add(undoItem);
				undoItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Z, ActionEvent.CTRL_MASK));

				// --------------------------------------------------

				JMenuItem redoItem = new JMenuItem("Redo", new ImageIcon(ImageManager.load("/assets/icons/redo.png")
						.getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));
				menu.add(redoItem);
...

		{
...

			{
				...
				button.setIcon(new ImageIcon(ImageManager.load("/assets/icons/project_new.png").getScaledInstance(16,
			...
			{
				ToolbarButton button = new ToolbarButton();
				button.setIcon(new ImageIcon(ImageManager.load("/assets/icons/save.png").getScaledInstance(16, 16,
			...
			{
				ToolbarButton button = new ToolbarButton();
				button.setIcon(new ImageIcon(ImageManager.load("/assets/icons/save_all.png").getScaledInstance(16, 16,
						java.awt.Image.SCALE_SMOOTH)));
			...
			{
				ToolbarButton button = new ToolbarButton();
				button.setIcon(new ImageIcon(ImageManager.load("/assets/icons/undo.png").getScaledInstance(16, 16,
						java.awt.Image.SCALE_SMOOTH)));
			...
			{
				ToolbarButton button = new ToolbarButton();
				button.setIcon(new ImageIcon(ImageManager.load("/assets/icons/redo.png").getScaledInstance(16, 16,
						java.awt.Image.SCALE_SMOOTH)));
			...
			{
				ToolbarButton button = new ToolbarButton();
				button.setIcon(new ImageIcon(ImageManager.load("/assets/icons/entity_new.png").getScaledInstance(16, 16,
						java.awt.Image.SCALE_SMOOTH)));
			...
			{
				ToolbarButton button = new ToolbarButton();
				button.setIcon(new ImageIcon(ImageManager.load("/assets/icons/item_new.png").getScaledInstance(16, 16,
						java.awt.Image.SCALE_SMOOTH)));
			...
			{
				ToolbarButton button = new ToolbarButton();
				button.setIcon(new ImageIcon(ImageManager.load("/assets/icons/export.png").getScaledInstance(16, 16,
						java.awt.Image.SCALE_SMOOTH)));
				...
				button.addActionListener(new AbstractAction() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						new Analyzer(new File(Explorer.selectedLabels.get(0).parent.path),ts);
						
						for(int i = 0; i < ts.tokens.size(); i++) {
							Token token = ts.tokens.get(i);
							
							System.out.println(token.getFullString());
						}
					}
				});
				toolbar.add(button);
...

		{
			...
			refresh.setIcon(new ImageIcon(ImageManager.load("/assets/icons/reload.png").getScaledInstance(16, 16,
					java.awt.Image.SCALE_SMOOTH)));
