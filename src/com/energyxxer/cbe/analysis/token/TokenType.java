...
public class TokenType {
	...
	public static final String SPECIAL = "SPECIAL"; // this
	...
	public static String getTypeOf(String token) {
		...
		String[][] patterns = { LangConstants.qualifiers, LangConstants.unit_types, LangConstants.unit_actions,
				LangConstants.braces, LangConstants.data_types, LangConstants.statements, LangConstants.dots,
				LangConstants.commas, LangConstants.booleans, LangConstants.nulls, LangConstants.special };
		String[] types = { QUALIFIER, UNIT_TYPE, UNIT_ACTION, BRACE, DATA_TYPE, STATEMENT, DOT, COMMA, BOOLEAN, NULL, SPECIAL };
