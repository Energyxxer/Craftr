...
public class MenuItems {
	public static JMenu newMenu(String title) {
		...
		newMenu.setIcon(new ImageIcon(
				ImageManager.load("/assets/icons/cbe.png").getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));

		// --------------------------------------------------

		JMenuItem projectItem = new JMenuItem("Project        ", new ImageIcon(ImageManager
				.load("/assets/icons/project_new.png").getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));
		...
		JMenuItem folderItem = new JMenuItem("Folder", new ImageIcon(ImageManager
				.load("/assets/icons/folder.png").getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));
		...
		JMenuItem entityItem = new JMenuItem("Entity", new ImageIcon(ImageManager.load("/assets/icons/entity_new.png")
		...
		JMenuItem itemItem = new JMenuItem("Item", new ImageIcon(ImageManager.load("/assets/icons/item_new.png")
				.getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));
	...
	public static JMenuItem fileItem(FileMenuItem type) {
		...
		case PASTE:
			...
			break;
		case RENAME:
			item = new JMenuItem("Rename", new ImageIcon(ImageManager.load("/assets/icons/rename.png")
					.getScaledInstance(16, 16, java.awt.Image.SCALE_SMOOTH)));
