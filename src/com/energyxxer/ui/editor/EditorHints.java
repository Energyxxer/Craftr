...
/**
 * This is supposed to show a tooltip when you hover over words in the file, but
 * the cooldown isn't really working.
 */
public class EditorHints implements MouseMotionListener {
	...
	private static boolean isToolTipVisible() {
		...
		try {
			...
			// We'll keep silent about this for now, but obviously we don't want
			// to hit this
			// e.printStackTrace();
			return false;
		}
