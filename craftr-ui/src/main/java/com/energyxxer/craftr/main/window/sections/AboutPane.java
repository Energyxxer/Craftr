...
import com.energyxxer.craftr.ui.decorationpane.DecorationObject;
import com.energyxxer.craftr.ui.decorationpane.DecorationPane;
...
import static com.energyxxer.craftr.main.Craftr.VERSION;
...
public class AboutPane extends DecorationPane {
    ...
    private AboutPane() {
        super(CraftrWindow.jframe, new Dimension(700, 460), ImageManager.load("/assets/logo/about.png"));
